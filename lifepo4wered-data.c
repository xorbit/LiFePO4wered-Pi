...
static const struct sVarScale var_scale[LFP_VAR_COUNT][3] = {
  ...
  /* VIN_OFFSET       */  { { 966667, 102300 }, { 966667, 102300 }, { 253723, 102300 } },
...
static const struct sVarDef var_table[LFP_VAR_COUNT] = {
  ...
  /* TOUCH_STATE      */  { { 0x19, 0x1B, 0x1D, 0x23, 0x1F, 0x25, 0x37 }, 1, 0, 0 },
  ...
  /* VIN              */  { { R_NA, R_NA, R_NA, 0x21, R_NA, 0x23, 0x33 }, 2, 0, 1 },
  /* VBAT             */  { { 0x15, 0x17, 0x19, 0x1D, 0x1B, 0x1F, 0x2F }, 2, 0, 1 },
  /* VOUT             */  { { 0x17, 0x19, 0x1B, 0x1F, 0x1D, 0x21, 0x31 }, 2, 0, 1 },
  /* IOUT             */  { { R_NA, R_NA, R_NA, R_NA, R_NA, R_NA, 0x35 }, 2, 0, 1 },
  ...
  /* WAKE_TIME        */  { { 0x12, 0x14, 0x16, 0x1A, 0x18, 0x1C, 0x24 }, 2, 2, 0 },
  ...
  /* RTC_TIME         */  { { R_NA, R_NA, R_NA, R_NA, R_NA, R_NA, 0x26 }, 4, 4, 0 },
  /* RTC_WAKE_TIME    */  { { R_NA, R_NA, R_NA, R_NA, R_NA, R_NA, 0x2A }, 4, 4, 0 },
  /* PI_RUNNING       */  { { 0x14, 0x16, 0x18, 0x1C, 0x1A, 0x1E, 0x2E }, 1, 1, 0 },
  /* CFG_WRITE        */  { { 0x11, 0x13, 0x15, 0x19, 0x17, 0x1B, 0x23 }, 1, 1, 0 },
};
