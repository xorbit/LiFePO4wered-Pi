...
struct {
  ...
  /* I2C_REG_VER      */  { 0x00,      1,      1,   1,  0 },
  /* I2C_ADDRESS      */  { 0x01,      1,      1,   1,  1 },
  /* LED_STATE        */  { 0x02,      1,      1,   1,  1 },
  /* TOUCH_STATE      */  { 0x19,      1,      1,   1,  0 },
  /* TOUCH_CAP_CYCLES */  { 0x03,      1,      1,   1,  1 },
  /* TOUCH_THRESHOLD  */  { 0x04,      1,      1,   1,  1 },
  /* TOUCH_HYSTERESIS */  { 0x05,      1,      1,   1,  1 },
  /* DCO_RSEL         */  { 0x06,      1,      1,   1,  1 },
  /* DCO_DCOMOD       */  { 0x07,      1,      1,   1,  1 },
  /* VIN              */  { 0x15,   5000,   1023,   2,  0 },
  /* VOUT             */  { 0x17, 554878, 102300,   2,  0 },
  /* VIN_MIN          */  { 0x08,   5000,   1023,   2,  2 },
  /* VIN_SHDN         */  { 0x0A,   5000,   1023,   2,  2 },
  /* VIN_BOOT         */  { 0x0C,   5000,   1023,   2,  2 },
  /* VOUT_MAX         */  { 0x0E, 554878, 102300,   2,  2 },
  /* AUTO_BOOT        */  { 0x10,      1,      1,   1,  1 },
  /* WAKE_TIME        */  { 0x12,      1,      1,   2,  2 },
  /* PI_RUNNING       */  { 0x14,      1,      1,   1,  1 },
  /* CFG_WRITE        */  { 0x11,      1,      1,   1,  1 },
};
